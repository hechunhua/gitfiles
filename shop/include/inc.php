...
return array(
	...
	'sp_core_path' => LEY_PATH, 
	'sp_drivers_path' => LEY_PATH, 
	'sp_include_path' => array( LEY_PATH.'/ext' ),
	...
	'allow_trace_onrelease' => FALSE, 
	'notice_php' => LEY_PATH."/notice.php", 
	...
	'sp_cache' => LEY_PATH.'/cache/tmp',
	'sp_session' => LEY_PATH.'/cache/ses',
	'sp_app_id' => 'sy',
	'controller_path' => APP_PATH.'/source', 
	'model_path' => LEY_PATH.'/class', 
	...
	'view' => array( 
		...
		'config' =>array(
			...
			'template_tpl' => LEY_PATH.'/cache/tpl',
		),
		'engine_name' => 'templateley', 
		'engine_path' => LEY_PATH.'/Template.php', 
	),
