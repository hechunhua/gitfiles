...
class syModel {
	...
	{
		if( null == $this->tbl_name )$this->tbl_name = $GLOBALS['G_QX']['db']['prefix'] . $this->table;
		if( '' == $GLOBALS['G_QX']['db_driver_path'] ){
			$GLOBALS['G_QX']['db_driver_path'] = $GLOBALS['G_QX']['sp_drivers_path'].'/'.$GLOBALS['G_QX']['db']['driver'].'.php';
		}
		$this->_db = syClass('db_'.$GLOBALS['G_QX']['db']['driver'], array(0=>$GLOBALS['G_QX']['db']), $GLOBALS['G_QX']['db_driver_path']);
	}
	...
	{
		if(in_array($name, $GLOBALS['G_QX']["auto_load_model"])){
